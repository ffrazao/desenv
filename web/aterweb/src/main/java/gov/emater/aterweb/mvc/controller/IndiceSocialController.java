...
public class IndiceSocialController extends _BaseController implements CadastroController<EntidadeBase, IndiceSocialCadFiltroDto> {

	private static final Logger logger = Logger.getLogger(IndiceSocialController.class);
	...
	@ResponseBody
	public JsonResponse filtrar(IndiceSocialCadFiltroDto filtro, BindingResult bindingResult) {
	...
	@ResponseBody
	public JsonResponse salvar(@Valid @RequestParam EntidadeBase entity, BindingResult bindingResult) {
