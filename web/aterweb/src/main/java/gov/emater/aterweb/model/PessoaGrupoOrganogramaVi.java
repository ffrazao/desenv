...
/**
 * The persistent class for the pessoa_grupo_organograma_vi database table.
 * 
 */
@Entity
@Table(name = "pessoa_grupo_organograma_vi", schema = EntidadeBase.PESSOA_SCHEMA)
public class PessoaGrupoOrganogramaVi extends EntidadeBase implements _ChavePrimaria<Integer> {
	...
	public PessoaGrupoOrganogramaVi() {
	}

	public PessoaGrupoOrganogramaVi(Integer id) {
		setId(id);
	}

	public PessoaGrupoOrganogramaVi(Integer id, String nome) {
		this(id);
		setNome(nome);
	}
