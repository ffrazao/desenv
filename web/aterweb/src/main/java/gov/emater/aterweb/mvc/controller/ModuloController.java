...
/**
 * Manipula requisiï¿½ï¿½es para o cadastro de mï¿½dulos
 * 
 */
@Controller
@RequestMapping(value = "/" + ModuloController.PAGINA)
public class ModuloController extends _BaseController implements CadastroController<Modulo, ModuloCadFiltroDto> {
	...
	@ResponseBody
	public JsonResponse filtrar(ModuloCadFiltroDto filtro, BindingResult bindingResult) {
	...
	@ResponseBody
	public JsonResponse salvar(@Valid @RequestBody Modulo entidade, BindingResult bindingResult) {
